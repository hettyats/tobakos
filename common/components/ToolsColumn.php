...
{
    public $header = '';
    public $template = '{view} {edit} {del} {pesan}';
    ...
    protected function initDefaultButtons()
    {
        ...
        if (!isset($this->buttons['pesan'])) {
            $this->buttons['pesan'] = function ($url, $model) {
                return  "<li>".Html::a('<span class="glyphicon glyphicon-ok-circle"></span> Booking', $url, [
                    'title' => Yii::t('yii', 'Booking'),
                     'data-pjax' => '0',
                ])."</li>";
            };
        }
